' Launches wslhost-interop-reaper.ps1 truly hidden (window style 0), bypassing the
...
cmd = "powershell.exe -NoProfile -ExecutionPolicy Bypass -File """ & scriptDir & "\wslhost-interop-reaper.ps1"""
